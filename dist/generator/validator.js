...
import { isVoidElement, getRequiredChildren } from '../widgets/registry';
// =============================================================================
 ...
 */
function validateElement(element, path, errors, warnings, seenIds) {
    // Check ID format
    if (!element.id) {
        errors.push({
 ...
 */
export function validateTemplateOrThrow(template) {
