 ...
 */
export function getWidgetDef(widgetType) {
    return WIDGET_REGISTRY[widgetType];
}
/**
 * Get widget definition by UpBuilder component type
 */
export function getWidgetDefByUpbuilderType(upbuilderType) {
 ...
 */
export function getUpbuilderType(widgetType) {
