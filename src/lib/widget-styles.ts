...
// Re-export CSSRule for convenience
export type { CSSRule };

/**
 * Generate CSS string from rules
 */
export function generateCSS(elementId: string, rules: CSSRule[], options?: { documentId?: string } | string): string {
 ...
 */
export function parseDimension(value: any, defaultUnit = 'px'): string | undefined {
 ...
 * Parse color value
 */
export function parseColor(value: any): string | undefined {
 ...
 */
export function parseTextAlign(value: string | undefined): string | undefined {
  if (!value) return undefined;
 ...
 */
export function parseTypography(settings: Record<string, any>, prefix = 'typography'): Record<string, string | undefined> {
 ...
 */
export function parseBoxShadow(shadow: any, settings?: Record<string, any>, prefix = 'button_box_shadow'): string | undefined {
 ...
 */
export function parseTextShadow(shadow: any, settings?: Record<string, any>, prefix = 'text_shadow'): string | undefined {
  if (!shadow || typeof shadow !== 'object') return undefined;
 ...
 */
export function parseTextStroke(settings: Record<string, any>, prefix = 'stroke'): Record<string, string | undefined> {
 ...
 * Parse border width
 */
function parseBorderWidth(value: any): string | undefined {
 ...
 */
export function parseBorder(settings: Record<string, any>, prefix = 'border'): Record<string, string | undefined> {
 ...
 */
export function parseBackground(settings: Record<string, any>, prefix = 'background'): Record<string, string | undefined> {
 ...
 * Parse border radius
 */
export function parseBorderRadius(value: any): string | undefined {
  if (!value) return undefined;
 ...
 */
export function parseSpacing(value: any): string | undefined {
  if (!value) return undefined;
 ...
 */
export function parseGap(value: any): string | undefined {
  if (!value) return undefined;
 ...
 */
export function normalizeSettings(settings: Record<string, any>): Record<string, any> {
...
export const BUTTON_SIZE_MAP: Record<string, { fontSize: string; padding: string }> = {
